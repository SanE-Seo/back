...
public record GetPostDistrictResponse(List<GetImageResponse> postImages, String title, String subTitle, String time, int likes, String distance, String level, String districts) {
