...
public record GetPostDistrictResponse(List<PostImage> postImages, String title, String subTitle, String time, String likes, String distance, String level, String districts) {
